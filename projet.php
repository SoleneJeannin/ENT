            ...
            <div class="wrapper">
                ...
                <div class="exam-top-wrapper block">
                    ...
                    <div class="wrapper-info">
                        <div class="info">
                            <h2> <a href="cours.php?id=<?= $projet['id_matiere'] ?? '' ?>">
                                    <?= $projet['nom_matiere'] ?? '' ?>
                                </a></h2>
                            <h2> <a
                                    href="mailto:<?= $projet['prof_prenom'] . '.' . $projet['prof_nom'] . '@univ-eiffel.fr' ?? '' ?>">
                                    <?= $projet['prof_prenom'] . ' ' . $projet['prof_nom'] ?? '' ?>
                                </a></h2>
                            <div class="data">
                                <p class="date"> Date de rendue: <br> <span class="date-span">
                                        <?= $projetStartDate ?? '' ?>
                                    </span></p>
                                <p class="time"> jusqu'à
                                    <?= $projetEndTime ?? '' ?>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="wrapper2and3">
                            <div class="description">
                                <h4>Description:</h4>
                                <p>
                                    <?= $projet['description_projet'] ?? 'Pas de description ajoutée' ?>
                                </p>
                                <?php
                            ...
                            <div class="deposer">
                                ...
                                <form action="upload_projet.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" name="student_name"
                                        value="<?= $_SESSION['user_prenom'] . "_" . $_SESSION['user_nom'] ?>">
                ...
                <div class="exam-noted block">
                    ...
                    <div class="wrapper-botom">
                        <div class="info">
                            ...
                            <p class="note">
                                <?= $projet2['note_projet'] ?? 'Pas evalué' ?> / 20
                            </p>
                        </div>
                        <div class="comment">
                            <h4>Commentaire de l'enseignant.e:</h4>
                            <p>
                                <?= $projet2['commentaire_projet'] ?? 'Pas de commentaire' ?>
                            </p>
                        </div>
