        ...
        if (isset($_SESSION["login"])) {
            ...
            <div class="bloc_description">
                <div class="texte">
                    ...
                    <p>Le restaurant universitaire (RU), d’une capacité de 550 élèves, est ouvert uniquement le midi, du
                        lundi au vendredi, de 11 h 30 à 14 h 00. Il est organisé selon différents pôles afin de proposer des
                        plats variés : végétariens, pizzas, poissons, viandes…</p>
                </div>
