        ...
        if ($role == 'Admin') { ?>
            ...
            <form action="traite_stock.php" method="POST">
                ...
                foreach ($result_stock as $stock) { ?>
                    <label for="stock_<?= $stock['id_materiel'] ?>"> Stock
                        <?= $stock['materiel_titre'] ?> :
                    </label>
                    <input type="number" id="stock_<?= $stock['id_materiel'] ?>" name="stock[<?= $stock['id_materiel'] ?>]"
                        value="<?= $stock['stock'] ?>"> <br> <br>
                    <?php
                }
                ?>
                <br>
