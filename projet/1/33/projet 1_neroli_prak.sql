...
--
-- Хост: localhost:3306
-- Время создания: Дек 13 2023 г., 10:30
...
--
-- Структура таблицы `acces_rapide`
--
...
--
-- Дамп данных таблицы `acces_rapide`
--
...
--
-- AUTO_INCREMENT для таблицы `acces_rapide`
--
ALTER TABLE `acces_rapide`
